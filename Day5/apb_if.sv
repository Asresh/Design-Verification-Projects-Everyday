...
//
// Self-contained for Day5. Shared between the UVM driver (drives the request
// channel) and the UVM monitor (samples the whole bus). The monitor feeds the
// UVM RAL explicit predictor. Parameters mirror the DUT defaults.
// -----------------------------------------------------------------------------
interface apb_if #(
